...
export class Header extends React.Component {
    render() {
        return <header className="home-header parallax pt-0">
                    ...
                    <div className="row vcenter">
                        <div className="col-sm-9">
                            <div className="features-small has-contained-menu">
                                <p>
                                    <FontAwesomeIcon icon={faIcon.faPhone} className={"text-white mr-1"}/>
                                    <span><b>0123 456 7890</b></span>
                                    <FontAwesomeIcon icon={faIcon.faEnvelope} className={"text-white ml-3 mr-1"}/>
            ...
            <nav id="nav-scroll"
                 className="navbar navbar-contained navbar-content navbar-expand-lg navbar-light bg-white menu-line menu-rounded fixed-top has-top-menu-big is-hidden"
